!function() {
    var e, t, o, n, r = {
        ...
        x: 0,
        y: 0
    }, s = !1, u = document.documentElement, d = [], f = /macintosh|mac os x/i.test(navigator.userAgent), m = {
        left: 37,
        up: 38,
        right: 39,
        down: 40,
    ...
    function w() {
        if (!s && document.body) {
            ...
            var n = document.body
              ...
              , d = n.scrollHeight;
            if (u = 0 <= document.compatMode.indexOf("CSS") ? r : n,
            e = n,
            a.keyboardSupport && X("keydown", S),
            top != self)
                l = !0;
            else if (Q && c < d && (n.offsetHeight <= c || r.offsetHeight <= c)) {
                var f, m = document.createElement("div");
                if (m.style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + u.scrollHeight + "px",
            ...
            a.fixedBackground || i || (n.style.backgroundAttachment = "scroll",
    ...
    function b(e, t, o) {
        ...
        1 != a.accelerationMax) {
            ...
            if (n < a.accelerationDelta) {
                var r = (1 + 50 / n) / 2;
                1 < r && (r = Math.min(r, a.accelerationMax),
                t *= r,
                o *= r)
            }
            y = Date.now()
        ...
        !v) {
            ...
            var s = function(n) {
                for (var r = Date.now(), i = 0, c = 0, u = 0; u < p.length; u++) {
                    var d = p[u]
                      , f = r - d.start
                      , m = f >= a.animationTime
                ...
                c && (e.scrollTop += c)),
                t || o || (p = []),
                p.length ? j(s, e, 1e3 / a.frameRate + 1) : (v = !1,
    ...
    function g(t) {
        ...
        if (t.defaultPrevented || t.ctrlKey)
            return !0;
        if (N(e, "embed") || N(o, "embed") && /\.pdf/i.test(o.src) || N(e, "object") || o.shadowRoot)
            return !0;
        var r = -t.wheelDeltaX || t.deltaX || 0
          , i = -t.wheelDeltaY || t.deltaY || 0;
        f && (t.wheelDeltaX && K(t.wheelDeltaX, 120) && (r = t.wheelDeltaX / Math.abs(t.wheelDeltaX) * -120),
        t.wheelDeltaY && K(t.wheelDeltaY, 120) && (i = t.wheelDeltaY / Math.abs(t.wheelDeltaY) * -120)),
        ...
        }(i) || (1.2 < Math.abs(r) && (r *= a.stepSize / 120),
        1.2 < Math.abs(i) && (i *= a.stepSize / 120),
        b(c, r, i),
        t.preventDefault(),
        void C()) : !l || !W || (Object.defineProperty(t, "target", {
    ...
    function S(t) {
        ...
        if (t.defaultPrevented || /^(textarea|select|embed|object)$/i.test(o.nodeName) || N(o, "input") && !r.test(o.type) || N(e, "video") || function(e) {
            ...
            return !0;
        if ((N(o, "button") || N(o, "input") && r.test(o.type)) && t.keyCode === m.spacebar)
            return !0;
        if (N(o, "input") && "radio" == o.type && h[t.keyCode])
            return !0;
        var i = 0
          , c = 0
          , s = z(e);
        if (!s)
            return !l || !W || parent.keydown(t);
        var u = s.clientHeight;
        switch (s == document.body && (u = window.innerHeight),
        t.keyCode) {
        case m.up:
            c = -a.arrowScroll;
            break;
        ...
        case m.pagedown:
            ...
            break;
        case m.home:
            s == document.body && document.scrollingElement && (s = document.scrollingElement),
            c = -s.scrollTop;
            break;
        case m.end:
    ...
    function V(e) {
        var t;
        return ((e *= a.pulseScale) < 1 ? e - (1 - Math.exp(-e)) : (e -= 1,
        (t = Math.exp(-1)) + (1 - Math.exp(-e)) * (1 - t))) * a.pulseNormalize
    }
    function F(e) {
        return 1 <= e ? 1 : e <= 0 ? 0 : (1 == a.pulseNormalize && (a.pulseNormalize /= V(1)),
        V(e))
    }
